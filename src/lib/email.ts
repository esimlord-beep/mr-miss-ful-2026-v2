    ...
    body: JSON.stringify({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 520px; margin: 0 auto; padding: 24px; color: #1e293b;">
          ...
          <p style="margin-bottom: 16px;">Hi <strong>${payerName}</strong>,</p>
          <p style="margin-bottom: 20px;">Thank you for voting! Here's a full summary of your transaction:</p>
          ...
          <div style="background: #f8fafc; border-radius: 12px; padding: 16px; margin-bottom: 24px;">
            <p style="font-size: 13px; font-weight: 700; color: #1e293b; margin: 0 0 6px;">Need Help?</p>
            <p style="font-size: 13px; color: #64748b; margin: 0;">If you have any issues with your payment or votes, please contact our support team and include your transaction reference above:</p>
            <p style="font-size: 13px; margin: 8px 0 0;">
              <a href="mailto:Esimlord09@gmail.com" style="color: #d97706; font-weight: 700;">Esimlord09@gmail.com</a>
              &nbsp;·&nbsp;
              <a href="https://wa.me/2348105789086" style="color: #d97706; font-weight: 700;">WhatsApp: +234 810 578 9086</a>
            </p>
          </div>
