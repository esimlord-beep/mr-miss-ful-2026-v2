      ...
      <div className="max-w-3xl mx-auto px-4 py-12 space-y-10">
        ...
        <section className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
          ...
          <div className="space-y-3 text-sm text-slate-600 font-medium leading-relaxed">
            ...
            <p>Votes are purchased via secure third-party payment processing (Paystack). Once a payment is successfully processed, votes are added to the relevant contestant or nominee's total and recorded as final.</p>
        ...
        <section className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
          ...
          <div className="space-y-3 text-sm text-slate-600 font-medium leading-relaxed">
            ...
            <p>We do not sell, rent, or share your personal information with third parties, except as necessary to process payments through our payment processor, Paystack.</p>
            <p>Payment card details are never stored on our servers — all payment processing is handled securely by Paystack in compliance with PCI-DSS standards.</p>
