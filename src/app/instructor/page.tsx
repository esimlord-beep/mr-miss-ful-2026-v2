...
export default async function InstructorPage() {
  ...
  const [{ data: contestants }, { data: sessions }, { data: tasks }, { data: attendance }, { data: taskRecords }, { data: notes }, { data: remarks }] =
    await Promise.all([
      ...
      adminSupabase.from("instructor_remarks_scores").select("contestant_id, score")
    ]);
